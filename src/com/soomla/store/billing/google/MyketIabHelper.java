 ...
 * More docs in parent.
 */
public class MyketIabHelper extends IabHelper {
...
//    public static final int SKU_QUERY_MAX_CHUNK_SIZE = 50;
     ...
     */
    public MyketIabHelper() {
        SoomlaUtils.LogDebug(TAG, "MyketIabHelper helper created.");
    }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == IabResult.BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                String publicKey = prefs.getString(MyketIabService.PUBLICKEY_KEY, "");
    ...
    private static String TAG = "SOOMLA MyketIabHelper";
